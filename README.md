...
![Protótipo - Home](img/telaInicialF.png)

### 🧥 Página de Detalhes (Figma)
![Protótipo - Detalhes](img/detalhesF.png)

### 📞 Página de Contato (Figma)
![Protótipo - Contato](img/contatoF.png)
...
![Site - Home](img/inicialHTML.png)

### 🧥 Página de Detalhes (HTML/CSS)
![Site - Detalhes](img/detalhesHTML.png)

### 📞 Página de Contato (HTML/CSS)
![Site - Contato](img/contatoHTML.png)
